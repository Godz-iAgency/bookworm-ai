...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `Generate 5 flashcards for '${title}' by '${author}' at ${readingLevel} level. Each card has a clear question and a concise answer based on the book's core principles. Return ONLY a valid JSON array with 'question' and 'answer' fields. No extra text.`;
