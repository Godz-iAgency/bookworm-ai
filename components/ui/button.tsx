...
const buttonVariants = cva(
  // active:scale-[0.97] is the press response, and it belongs here rather than
  // on individual buttons: hover states never fire on a touchscreen, so without
  // it the majority of taps in a phone-first app produce no feedback at all
  // until the action itself completes. duration-75 keeps it on the press rather
  // than trailing behind the finger.
